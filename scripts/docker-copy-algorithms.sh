...
function copyLibRemote {
  ...
  ssh root@172.17.0.100 "rm $LIB_TMP_DIR/$BIOHADOOP_ALGORITHMS_CURRENT"
  
  scp -r $BIOHADOOP_ALGORITHMS_PROJECT_HOME/target/$BIOHADOOP_ALGORITHMS_CURRENT root@172.17.0.100:$LIB_TMP_DIR
  ...
  ssh root@172.17.0.100 "/opt/hadoop/current/bin/hdfs dfs -copyFromLocal -f $LIB_TMP_DIR/$BIOHADOOP_ALGORITHMS_CURRENT $LIB_HDFS_DIR/$BIOHADOOP_ALGORITHMS_CURRENT"
...
function copyDataRemote {
  ...
  scp -r $BIOHADOOP_ALGORITHMS_PROJECT_HOME/data/* root@172.17.0.100:$DATA_TMP_DIR
...
function copyConfRemote {
  ...
  scp -r $BIOHADOOP_ALGORITHMS_PROJECT_HOME/conf/* root@172.17.0.100:$CONF_TMP_DIR
